...
public class MFlag extends Entity<MFlag> implements Prioritized, Registerable, Named
{
	...
	public final static transient String ID_MUTED = "muted";
	...
	public final static transient int PRIORITY_MUTED = 16_000;
	...
	public static MFlag getFlagMuted() { return getCreative(PRIORITY_MUTED, ID_MUTED, ID_MUTED, "Is the faction muted from notifications?", "The faction is muted from notifications.", "The faction is NOT muted from notifications.", false, false, true); }
